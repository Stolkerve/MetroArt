  ...
  return (
    ...
    >
        <div className="w-full h-full flex flex-col justify-center items-center backdrop-blur-lg">
            <h1 className="mt-5 text-center text-8xl text-[#F77F00] font-extrabold drop-shadow-lg"
              style={{textShadow: "-4px 4px #1D3557"}}
            >Bienvenido a MetroArt</h1>
        </div>
        <div className="absolute bg-[#F77F00] -bottom-2 w-full p-6 z-10"
          style={{borderRadius: "80% 80% 0% 0%/120% 120% 0% 0%"}}
        />
        <div className="absolute bg-white -bottom-1 w-full p-6 "
          style={{borderRadius: "80% 80% 0% 0%/120% 120% 0% 0%"}}
        />
    </header>
    ...
    <div className="flex flex-col justify-center leading-normal px-32  space-y-16 relative">
      <Fade cascade delay={100} duration={1000} damping={0.2} triggerOnce>
        <div className="flex justify-between w-full items-center">
          <div className="flex flex-col justify-center rounded-lg p-6 bg-white text-stone-900 max-w-lg h-fit space-y-6 text-center"
            style={{boxShadow: "-8px 8px 0px 0px #1D3557"}}
          >
            <div className="flex w-full justify-center items-center">
              <h1 className="p-4 rounded-lg text-xl font-bold text-white bg-[#1D3557]">Quienes somos</h1>
            </div>
            <p className="text-lg">
        ...
        <div className="flex justify-center w-full items-center pb-32">
          <div className="flex flex-wrap justify-center w-fit text-center text-lg bg-white text-stone-800 p-6 gap-8 rounded-lg"
          ...
          >
            ...
            <div className="max-w-md space-y-4">
              <div className="flex w-full justify-center items-center">
                <h1 className="p-4 rounded-lg text-xl font-bold text-white bg-[#1D3557]">Objetivos</h1>
              </div>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
              </p>
      ...
      <div className="absolute bg-[#1D3557] -bottom-2 left-0 w-full p-6 z-10"
        style={{borderRadius: "80% 80% 0% 0%/120% 120% 0% 0%"}}
      />
      <div className="absolute bg-white -bottom-1 left-0 w-full p-6 "
        style={{borderRadius: "80% 80% 0% 0%/120% 120% 0% 0%"}}
      />
    </div>
    <div className="bg-[#1D3557] text-white space-y-16 px-32 pb-12">
        ...
        !loading ? (
          <Zoom duration={250} triggerOnce>
            <div className="flex justify-center mt-16 space-y-12">
              <input className="rounded-2xl w-full h-fit max-w-xl text-black p-3" type="text" placeholder="Autor, nombre del tour y nombre de la obra..."/>
            </div>
          </Zoom>
        ) : (<></>)
      }
      <div className="flex flex-col justify-center h-full w-full space-y-8">
        {
          loading ? (
              <Zoom duration={250} delay={100} triggerOnce onVisibilityChange={setTimer} className="flex justify-center">
                <LineWave
                  height="250"
                  width="250"
                  color="#F77F00"
              ...
              <Zoom cascade duration={250} direction="up" triggerOnce className="flex justify-center">
                {
                  [0, 1, 2, 3, 4, 5].map((v) => {
                    return (
                      <div id={v.toString()} className="flex w-full rounded-2xl bg-[#F77F00] max-w-6xl h-[15rem] overflow-clip text-white tour-transitions">
